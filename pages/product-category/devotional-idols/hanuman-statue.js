...
export default function HanumanStatue() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'han1', name: 'Hanuman Flying', price: 1099, icon: 'fa-wind', description: 'Flying Hanuman with mountain', image: '/products/hanuman-flying.jpg' },
    { id: 'han2', name: 'Hanuman Standing', price: 999, icon: 'fa-praying-hands', description: 'Standing devotee pose', image: '/products/hanuman-standing.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Hanuman Statues | ROBOHATCH</title>
        <meta name="description" content="Powerful Hanuman deity statues" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-wind mr-3"></i> Hanuman Statues
            </h1>
            <p className="text-lg text-gray-600">Powerful Hanuman deity statues</p>
          </div>
