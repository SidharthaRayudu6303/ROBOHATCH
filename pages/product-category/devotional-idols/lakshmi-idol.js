...
export default function LakshmiIdol() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'lak1', name: 'Lakshmi with Lotus', price: 949, icon: 'fa-spa', description: 'Goddess Lakshmi on lotus', image: '/products/lakshmi-lotus.jpg' },
    { id: 'lak2', name: 'Lakshmi Standing', price: 899, icon: 'fa-praying-hands', description: 'Standing blessing Lakshmi', image: '/products/lakshmi-standing.jpg' },
    { id: 'lak3', name: 'Lakshmi with Owl', price: 999, icon: 'fa-dove', description: 'Lakshmi with owl vehicle', image: '/products/lakshmi-owl.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Lakshmi Idols | ROBOHATCH</title>
        <meta name="description" content="Goddess of wealth and prosperity" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-spa mr-3"></i> Lakshmi Idols
            </h1>
            <p className="text-lg text-gray-600">Goddess of wealth and prosperity</p>
          </div>
