...
export default function SaraswatiIdol() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'sar1', name: 'Saraswati with Veena', price: 999, icon: 'fa-book-open', description: 'Goddess Saraswati with veena', image: '/products/saraswati-veena.jpg' },
    { id: 'sar2', name: 'Saraswati on Lotus', price: 1049, icon: 'fa-graduation-cap', description: 'Saraswati seated on lotus', image: '/products/saraswati-lotus.jpg' },
    { id: 'sar3', name: 'Saraswati with Swan', price: 1099, icon: 'fa-dove', description: 'Saraswati with swan vehicle', image: '/products/saraswati-swan.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Saraswati Idols | ROBOHATCH</title>
        <meta name="description" content="Goddess of knowledge and arts" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-book-open mr-3"></i> Saraswati Idols
            </h1>
            <p className="text-lg text-gray-600">Goddess of knowledge and arts</p>
          </div>
