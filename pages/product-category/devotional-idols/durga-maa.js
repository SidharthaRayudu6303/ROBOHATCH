...
export default function DurgaMaa() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'dur1', name: 'Durga with Lion', price: 1399, icon: 'fa-fire', description: 'Maa Durga riding lion', image: '/products/durga-lion.jpg' },
    { id: 'dur2', name: 'Durga Mahishasura', price: 1499, icon: 'fa-fist-raised', description: 'Durga slaying Mahishasura', image: '/products/durga-mahishasura.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Durga Maa Idols | ROBOHATCH</title>
        <meta name="description" content="Divine mother Durga statues" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-fire mr-3"></i> Durga Maa
            </h1>
            <p className="text-lg text-gray-600">Divine mother Durga statues</p>
          </div>
