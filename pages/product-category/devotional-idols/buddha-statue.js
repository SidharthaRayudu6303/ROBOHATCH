...
export default function BuddhaStatue() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'bud1', name: 'Buddha Meditation', price: 1199, icon: 'fa-spa', description: 'Peaceful meditation Buddha', image: '/products/buddha-meditation.jpg' },
    { id: 'bud2', name: 'Buddha Laughing', price: 999, icon: 'fa-smile', description: 'Happy laughing Buddha', image: '/products/buddha-laughing.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Buddha Statues | ROBOHATCH</title>
        <meta name="description" content="Peaceful Buddha meditation statues" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-spa mr-3"></i> Buddha Statues
            </h1>
            <p className="text-lg text-gray-600">Peaceful Buddha meditation statues</p>
          </div>
