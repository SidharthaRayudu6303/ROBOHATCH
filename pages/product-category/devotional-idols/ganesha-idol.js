...
export default function GaneshaIdol() {
  ...
  const products = [
    { id: 'gan1', name: 'Ganesha Sitting', price: 899, icon: 'fa-om', description: 'Traditional sitting Ganesha idol', image: '/products/ganesha-sitting.jpg' },
    { id: 'gan2', name: 'Ganesha Dancing', price: 999, icon: 'fa-praying-hands', description: 'Dancing Ganesha with modak', image: '/products/ganesha-dancing.jpg' },
    { id: 'gan3', name: 'Ganesha with Mushak', price: 1099, icon: 'fa-om', description: 'Ganesha with mouse vehicle', image: '/products/ganesha-mushak.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Ganesha Idols | ROBOHATCH</title>
        <meta name="description" content="Beautiful Ganesha idol designs" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-om mr-3"></i> Ganesha Idols
            </h1>
            <p className="text-lg text-gray-600">Beautiful Ganesha idol designs</p>
          </div>
