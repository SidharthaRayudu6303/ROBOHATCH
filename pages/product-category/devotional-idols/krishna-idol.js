...
export default function KrishnaIdol() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'kri1', name: 'Krishna with Flute', price: 949, icon: 'fa-music', description: 'Krishna playing flute', image: '/products/krishna-flute.jpg' },
    { id: 'kri2', name: 'Baby Krishna', price: 849, icon: 'fa-child', description: 'Bal Krishna with butter', image: '/products/krishna-baby.jpg' },
    { id: 'kri3', name: 'Krishna with Radha', price: 1249, icon: 'fa-heart', description: 'Radha Krishna together', image: '/products/krishna-radha.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Krishna Idols | ROBOHATCH</title>
        <meta name="description" content="Divine Krishna idol collection" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-music mr-3"></i> Krishna Idols
            </h1>
            <p className="text-lg text-gray-600">Divine Krishna idol collection</p>
          </div>
