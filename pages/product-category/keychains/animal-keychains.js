...
export default function AnimalKeychains() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'ak1', name: 'Cat Keychain', price: 249, icon: 'fa-cat', description: 'Cute cat shaped keychain', image: '/products/animal-cat.jpg' },
    { id: 'ak2', name: 'Dog Keychain', price: 249, icon: 'fa-dog', description: 'Adorable dog shaped keychain', image: '/products/animal-dog.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Animal Keychains | ROBOHATCH</title>
        <meta name="description" content="Cute animal shaped keychains" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-paw mr-3"></i> Animal Keychains
            </h1>
            <p className="text-lg text-gray-600">Cute animal shaped keychains</p>
          </div>
