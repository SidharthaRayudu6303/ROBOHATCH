...
export default function PhotoKeychain() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'pk1', name: 'Rectangle Photo Keychain', price: 299, icon: 'fa-image', description: 'Classic rectangle shaped photo keychain', image: '/products/photo-rectangle.jpg' },
    { id: 'pk2', name: 'Heart Photo Keychain', price: 349, icon: 'fa-heart', description: 'Romantic heart-shaped photo keychain', image: '/products/photo-heart.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Photo Keychains | ROBOHATCH</title>
        <meta name="description" content="Custom photo keychains with your favorite pictures" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-image mr-3"></i> Photo Keychains
            </h1>
            <p className="text-lg text-gray-600">Keychains with your favorite photos</p>
          </div>
