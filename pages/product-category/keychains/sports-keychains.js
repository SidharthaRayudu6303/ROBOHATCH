...
export default function SportsKeychains() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'sk1', name: 'Football Keychain', price: 249, icon: 'fa-football-ball', description: 'Soccer/Football shaped keychain', image: '/products/sports-football.jpg' },
    { id: 'sk2', name: 'Basketball Keychain', price: 249, icon: 'fa-basketball-ball', description: 'Basketball shaped keychain', image: '/products/sports-basketball.jpg' },
    { id: 'sk3', name: 'Cricket Bat Keychain', price: 279, icon: 'fa-baseball-ball', description: 'Cricket equipment keychain', image: '/products/sports-cricket.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Sports Keychains | ROBOHATCH</title>
        <meta name="description" content="Sports themed keychains for fans" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-trophy mr-3"></i> Sports Keychains
            </h1>
            <p className="text-lg text-gray-600">Sports themed keychains for fans</p>
          </div>
