...
export default function LogoKeychain() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'lk1', name: 'Company Logo Keychain', price: 249, icon: 'fa-building', description: 'Custom business logo keychain for corporate gifts', image: '/products/logo-company.jpg' },
    { id: 'lk2', name: 'Brand Logo Keychain', price: 299, icon: 'fa-tag', description: 'Popular brand logo keychain collection', image: '/products/logo-brand.jpg' },
    { id: 'lk3', name: '3D Embossed Logo Keychain', price: 379, icon: 'fa-cube', description: 'Premium 3D raised logo keychain', image: '/products/logo-3d.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Logo Keychains | ROBOHATCH</title>
        <meta name="description" content="Custom logo keychains for businesses and brands" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-tag mr-3"></i> Logo Keychains
            </h1>
            <p className="text-lg text-gray-600">Professional logo keychains for businesses and brands</p>
          </div>
