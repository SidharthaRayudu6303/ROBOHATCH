...
export default function CustomNameKeychain() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'cnk1', name: 'Basic Name Keychain', price: 199, icon: 'fa-signature', description: 'Classic personalized name keychain in standard font', image: '/products/name-basic.jpg' },
    { id: 'cnk2', name: 'Cursive Name Keychain', price: 249, icon: 'fa-pen-fancy', description: 'Elegant cursive style name keychain', image: '/products/name-cursive.jpg' },
    { id: 'cnk3', name: 'Bold Name Keychain', price: 229, icon: 'fa-bold', description: 'Strong bold font name keychain', image: '/products/name-bold.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Custom Name Keychains | ROBOHATCH</title>
        <meta name="description" content="Personalized custom name keychains in various fonts and styles" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-signature mr-3"></i> Custom Name Keychains
            </h1>
            <p className="text-lg text-gray-600">Personalized name keychains with your custom text</p>
          </div>
