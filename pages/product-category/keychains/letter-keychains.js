...
export default function LetterKeychains() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'lk1', name: 'Initial A-Z Keychain', price: 229, icon: 'fa-font', description: 'Single letter initial keychain', image: '/products/letter-single.jpg' },
    { id: 'lk2', name: 'Monogram Keychain', price: 279, icon: 'fa-signature', description: 'Elegant monogram style letter keychain', image: '/products/letter-monogram.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Letter Keychains | ROBOHATCH</title>
        <meta name="description" content="Elegant single letter initial keychains" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-font mr-3"></i> Letter Keychains
            </h1>
            <p className="text-lg text-gray-600">Elegant single letter initial keychains</p>
          </div>
