...
export default function DesignerKeychain() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'dk1', name: 'Luxury Designer Keychain', price: 449, icon: 'fa-gem', description: 'Premium luxury designer keychain with crystals', image: '/products/designer-luxury.jpg' },
    { id: 'dk2', name: 'Geometric Designer Keychain', price: 399, icon: 'fa-shapes', description: 'Modern geometric pattern designer keychain', image: '/products/designer-geometric.jpg' },
    { id: 'dk3', name: 'Minimalist Designer Keychain', price: 329, icon: 'fa-minus', description: 'Sleek minimalist designer keychain', image: '/products/designer-minimal.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Designer Keychains | ROBOHATCH</title>
        <meta name="description" content="Stylish designer keychain collection" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-star mr-3"></i> Designer Keychains
            </h1>
            <p className="text-lg text-gray-600">Stylish designer keychain collection</p>
          </div>
