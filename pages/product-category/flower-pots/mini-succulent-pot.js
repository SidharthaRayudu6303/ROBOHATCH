...
export default function MiniSucculentPot() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'succ1', name: 'Mini Succulent Set', price: 299, icon: 'fa-spa', description: 'Set of 3 mini pots', image: '/products/pot-mini.jpg' },
    { id: 'succ2', name: 'Cactus Pot', price: 249, icon: 'fa-seedling', description: 'Small cactus planter', image: '/products/pot-cactus.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Mini Succulent Pot | ROBOHATCH</title>
        <meta name="description" content="Small succulent planters" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-spa mr-3"></i> Mini Succulent Pot
            </h1>
            <p className="text-lg text-gray-600">Small succulent planters</p>
          </div>
