...
export default function HangingPlanter() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'hang1', name: 'Macrame Hanging Planter', price: 549, icon: 'fa-cloud', description: 'Macrame style hanger', image: '/products/planter-macrame.jpg' },
    { id: 'hang2', name: 'Geometric Hanging Pot', price: 599, icon: 'fa-shapes', description: 'Geometric hanging design', image: '/products/planter-hang-geo.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Hanging Planter | ROBOHATCH</title>
        <meta name="description" content="Hanging plant pots" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-cloud mr-3"></i> Hanging Planter
            </h1>
            <p className="text-lg text-gray-600">Hanging plant pots</p>
          </div>
