...
export default function WallMountPlanter() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'wall1', name: 'Wall Mounted Planter', price: 499, icon: 'fa-grip-horizontal', description: 'Wall mount pot', image: '/products/planter-wall.jpg' },
    { id: 'wall2', name: 'Vertical Garden Set', price: 799, icon: 'fa-grip-vertical', description: 'Vertical planter set', image: '/products/planter-vertical.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Wall Mount Planter | ROBOHATCH</title>
        <meta name="description" content="Wall mounted planters" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-grip-horizontal mr-3"></i> Wall Mount Planter
            </h1>
            <p className="text-lg text-gray-600">Wall mounted planters</p>
          </div>
