...
export default function LargeFloorPlanter() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'floor1', name: 'Tall Floor Planter', price: 899, icon: 'fa-wine-bottle', description: 'Large tall planter', image: '/products/planter-tall.jpg' },
    { id: 'floor2', name: 'Wide Floor Pot', price: 1099, icon: 'fa-drum', description: 'Wide floor planter', image: '/products/planter-wide.jpg' },
    { id: 'floor3', name: 'Decorative Floor Vase', price: 999, icon: 'fa-vial', description: 'Decorative floor vase', image: '/products/planter-vase.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Large Floor Planter | ROBOHATCH</title>
        <meta name="description" content="Large floor planters" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-wine-bottle mr-3"></i> Large Floor Planter
            </h1>
            <p className="text-lg text-gray-600">Large floor planters</p>
          </div>
