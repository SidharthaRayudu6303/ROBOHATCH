...
export default function GeometricPlanter() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'gp1', name: 'Hexagonal Planter', price: 449, icon: 'fa-shapes', description: 'Hexagon shape pot', image: '/products/planter-hex.jpg' },
    { id: 'gp2', name: 'Triangular Planter', price: 399, icon: 'fa-triangle', description: 'Triangle design pot', image: '/products/planter-tri.jpg' },
    { id: 'gp3', name: 'Faceted Planter', price: 549, icon: 'fa-gem', description: 'Multi-faceted design', image: '/products/planter-facet.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Geometric Planter | ROBOHATCH</title>
        <meta name="description" content="Geometric planters" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-shapes mr-3"></i> Geometric Planter
            </h1>
            <p className="text-lg text-gray-600">Geometric planters</p>
          </div>
