...
export default function SelfWateringPot() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'sw1', name: 'Self-Watering Planter', price: 649, icon: 'fa-tint', description: 'Auto watering system', image: '/products/pot-self-water.jpg' },
    { id: 'sw2', name: 'Smart Planter', price: 899, icon: 'fa-water', description: 'Smart watering pot', image: '/products/pot-smart.jpg' },
    { id: 'sw3', name: 'Hydroponic Planter', price: 749, icon: 'fa-droplet', description: 'Hydroponic system', image: '/products/pot-hydro.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Self-Watering Pot | ROBOHATCH</title>
        <meta name="description" content="Self-watering planters" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-tint mr-3"></i> Self-Watering Pot
            </h1>
            <p className="text-lg text-gray-600">Self-watering planters</p>
          </div>
