...
export default function DecorativePotSet() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'dps1', name: 'Mixed Pot Set', price: 849, icon: 'fa-layer-group', description: 'Set of 5 varied pots', image: '/products/pot-set-mixed.jpg' },
    { id: 'dps2', name: 'Matching Pot Collection', price: 999, icon: 'fa-th', description: 'Coordinated pot set', image: '/products/pot-set-match.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Decorative Pot Set | ROBOHATCH</title>
        <meta name="description" content="Decorative planter sets" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-layer-group mr-3"></i> Decorative Pot Set
            </h1>
            <p className="text-lg text-gray-600">Decorative planter sets</p>
          </div>
