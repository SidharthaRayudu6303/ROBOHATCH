...
export default function ModernPlanter() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'mod1', name: 'Minimalist Planter', price: 399, icon: 'fa-seedling', description: 'Clean modern design', image: '/products/planter-minimal.jpg' },
    { id: 'mod2', name: 'Cylindrical Planter', price: 449, icon: 'fa-leaf', description: 'Sleek cylinder pot', image: '/products/planter-cylinder.jpg' },
    { id: 'mod3', name: 'Square Planter', price: 499, icon: 'fa-square', description: 'Contemporary square pot', image: '/products/planter-square.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Modern Planter | ROBOHATCH</title>
        <meta name="description" content="Contemporary planters" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-seedling mr-3"></i> Modern Planter
            </h1>
            <p className="text-lg text-gray-600">Contemporary planters</p>
          </div>
