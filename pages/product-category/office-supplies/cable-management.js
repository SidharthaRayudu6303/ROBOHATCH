...
export default function CableManagement() {
  ...
  const products = [
    { id: 'cm1', name: 'Cable Clips Set', price: 249, icon: 'fa-paperclip', description: 'Desk cable organizers', image: '/products/cable-clips.jpg' },
    { id: 'cm2', name: 'Cable Box', price: 449, icon: 'fa-box', description: 'Hide cables neatly', image: '/products/cable-box.jpg' },
    { id: 'cm3', name: 'Cable Sleeve', price: 299, icon: 'fa-grip-lines-vertical', description: 'Flexible cable sleeve', image: '/products/cable-sleeve.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Cable Management | ROBOHATCH</title>
        <meta name="description" content="Office cable organization" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-paperclip mr-3"></i> Cable Management
            </h1>
            <p className="text-lg text-gray-600">Office cable organization</p>
          </div>
