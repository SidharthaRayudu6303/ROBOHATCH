...
export default function PhoneDocks() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'pd1', name: 'Adjustable Phone Dock', price: 399, icon: 'fa-mobile-alt', description: 'Multi-angle phone dock', image: '/products/dock-adjustable.jpg' },
    { id: 'pd2', name: 'Wireless Charging Dock', price: 699, icon: 'fa-charging-station', description: 'Qi wireless charging', image: '/products/dock-wireless.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Phone Docks | ROBOHATCH</title>
        <meta name="description" content="Desktop phone docking stations" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-mobile-alt mr-3"></i> Phone Docks
            </h1>
            <p className="text-lg text-gray-600">Desktop phone docking stations</p>
          </div>
