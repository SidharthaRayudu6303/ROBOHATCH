...
export default function DeskOrganizers() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'do1', name: 'Multi-Compartment Organizer', price: 599, icon: 'fa-th', description: 'Complete desk organization', image: '/products/organizer-multi.jpg' },
    { id: 'do2', name: 'Drawer Organizer', price: 449, icon: 'fa-inbox', description: 'Drawer divider set', image: '/products/organizer-drawer.jpg' },
    { id: 'do3', name: 'Desktop Caddy', price: 349, icon: 'fa-layer-group', description: 'Compact desktop caddy', image: '/products/organizer-caddy.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Desk Organizers | ROBOHATCH</title>
        <meta name="description" content="Desk organization solutions" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-th mr-3"></i> Desk Organizers
            </h1>
            <p className="text-lg text-gray-600">Desk organization solutions</p>
          </div>
