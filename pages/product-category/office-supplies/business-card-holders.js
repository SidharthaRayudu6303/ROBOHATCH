...
export default function BusinessCardHolders() {
  ...
  const products = [
    { id: 'bch1', name: 'Executive Card Holder', price: 399, icon: 'fa-id-card', description: 'Premium card holder', image: '/products/card-exec.jpg' },
    { id: 'bch2', name: 'Desktop Card Stand', price: 349, icon: 'fa-address-card', description: 'Professional card display', image: '/products/card-stand.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Business Card Holders | ROBOHATCH</title>
        <meta name="description" content="Professional business card holders" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-id-card mr-3"></i> Business Card Holders
            </h1>
            <p className="text-lg text-gray-600">Professional business card holders</p>
          </div>
