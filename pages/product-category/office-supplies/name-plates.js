...
export default function NamePlates() {
  ...
  const products = [
    { id: 'np1', name: 'Desk Name Plate', price: 349, icon: 'fa-id-badge', description: 'Professional desk nameplate', image: '/products/nameplate-desk.jpg' },
    { id: 'np2', name: 'Door Name Plate', price: 399, icon: 'fa-door-open', description: 'Office door nameplate', image: '/products/nameplate-door.jpg' },
    { id: 'np3', name: 'Custom Engraved Plate', price: 449, icon: 'fa-edit', description: 'Custom text engraving', image: '/products/nameplate-custom.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Name Plates | ROBOHATCH</title>
        <meta name="description" content="Professional office name plates" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-id-badge mr-3"></i> Name Plates
            </h1>
            <p className="text-lg text-gray-600">Professional office name plates</p>
          </div>
