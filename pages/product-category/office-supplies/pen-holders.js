...
export default function PenHolders() {
  ...
  const products = [
    { id: 'ph1', name: 'Hexagonal Pen Holder', price: 299, icon: 'fa-pen', description: 'Modern hexagonal design', image: '/products/pen-hex.jpg' },
    { id: 'ph2', name: 'Desk Organizer Pen Holder', price: 449, icon: 'fa-pencil-alt', description: 'Multi-compartment organizer', image: '/products/pen-organizer.jpg' },
    { id: 'ph3', name: 'Minimalist Pen Stand', price: 249, icon: 'fa-pen-fancy', description: 'Simple modern stand', image: '/products/pen-minimal.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Pen Holders | ROBOHATCH</title>
        <meta name="description" content="Desk pen holders and organizers" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-pen mr-3"></i> Pen Holders
            </h1>
            <p className="text-lg text-gray-600">Desk pen holders and organizers</p>
          </div>
