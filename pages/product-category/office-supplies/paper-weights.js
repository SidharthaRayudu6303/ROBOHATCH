...
export default function PaperWeights() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'pw1', name: 'Crystal Paperweight', price: 449, icon: 'fa-gem', description: 'Clear crystal design', image: '/products/paperweight-crystal.jpg' },
    { id: 'pw2', name: 'Geometric Paperweight', price: 399, icon: 'fa-cube', description: 'Modern geometric shape', image: '/products/paperweight-geo.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Paper Weights | ROBOHATCH</title>
        <meta name="description" content="Decorative desk paperweights" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-gem mr-3"></i> Paper Weights
            </h1>
            <p className="text-lg text-gray-600">Decorative desk paperweights</p>
          </div>
