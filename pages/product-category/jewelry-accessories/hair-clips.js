...
export default function HairClips() {
  ...
  const products = [
    { id: 'hc1', name: 'Geometric Hair Clip', price: 249, icon: 'fa-shapes', description: 'Modern geometric design', image: '/products/clip-geometric.jpg' },
    { id: 'hc2', name: 'Butterfly Hair Clip', price: 279, icon: 'fa-dove', description: 'Butterfly shaped clip', image: '/products/clip-butterfly.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Hair Clips | ROBOHATCH</title>
        <meta name="description" content="Stylish hair accessories" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-shapes mr-3"></i> Hair Clips
            </h1>
            <p className="text-lg text-gray-600">Stylish hair accessories</p>
          </div>
