...
export default function Brooches() {
  ...
  const products = [
    { id: 'bro1', name: 'Floral Brooch', price: 349, icon: 'fa-spa', description: 'Floral design brooch', image: '/products/brooch-floral.jpg' },
    { id: 'bro2', name: 'Vintage Brooch', price: 399, icon: 'fa-crown', description: 'Vintage style brooch', image: '/products/brooch-vintage.jpg' },
    { id: 'bro3', name: 'Modern Brooch', price: 329, icon: 'fa-star', description: 'Contemporary brooch', image: '/products/brooch-modern.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Brooches | ROBOHATCH</title>
        <meta name="description" content="Decorative brooch pins" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-spa mr-3"></i> Brooches
            </h1>
            <p className="text-lg text-gray-600">Decorative brooch pins</p>
          </div>
