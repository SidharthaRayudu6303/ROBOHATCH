...
export default function Rings() {
  ...
  const products = [
    { id: 'ring1', name: 'Band Ring', price: 399, icon: 'fa-ring', description: 'Simple band ring', image: '/products/ring-band.jpg' },
    { id: 'ring2', name: 'Statement Ring', price: 499, icon: 'fa-gem', description: 'Bold statement ring', image: '/products/ring-statement.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Rings | ROBOHATCH</title>
        <meta name="description" content="Custom 3D printed rings" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-ring mr-3"></i> Rings
            </h1>
            <p className="text-lg text-gray-600">Custom 3D printed rings</p>
          </div>
