...
export default function CustomPendants() {
  ...
  const products = [
    { id: 'cp1', name: 'Name Pendant', price: 599, icon: 'fa-gem', description: 'Custom name pendant', image: '/products/pendant-name.jpg' },
    { id: 'cp2', name: 'Photo Pendant', price: 649, icon: 'fa-heart', description: 'Photo engraved pendant', image: '/products/pendant-photo.jpg' },
    { id: 'cp3', name: 'Symbol Pendant', price: 579, icon: 'fa-star', description: 'Custom symbol pendant', image: '/products/pendant-symbol.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Custom Pendants | ROBOHATCH</title>
        <meta name="description" content="Personalized custom pendants" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-gem mr-3"></i> Custom Pendants
            </h1>
            <p className="text-lg text-gray-600">Personalized custom pendants</p>
          </div>
