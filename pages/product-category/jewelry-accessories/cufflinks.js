...
export default function Cufflinks() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'cuff1', name: 'Classic Cufflinks', price: 499, icon: 'fa-square', description: 'Elegant classic cufflinks', image: '/products/cufflink-classic.jpg' },
    { id: 'cuff2', name: 'Modern Cufflinks', price: 549, icon: 'fa-shapes', description: 'Contemporary design', image: '/products/cufflink-modern.jpg' },
    { id: 'cuff3', name: 'Initial Cufflinks', price: 579, icon: 'fa-font', description: 'Personalized initial', image: '/products/cufflink-initial.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Cufflinks | ROBOHATCH</title>
        <meta name="description" content="Professional cufflinks" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-square mr-3"></i> Cufflinks
            </h1>
            <p className="text-lg text-gray-600">Professional cufflinks</p>
          </div>
