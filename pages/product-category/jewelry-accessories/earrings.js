...
export default function Earrings() {
  ...
  const products = [
    { id: 'ear1', name: 'Geometric Earrings', price: 399, icon: 'fa-gem', description: 'Modern geometric design', image: '/products/earring-geometric.jpg' },
    { id: 'ear2', name: 'Floral Earrings', price: 449, icon: 'fa-spa', description: 'Floral pattern earrings', image: '/products/earring-floral.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Earrings | ROBOHATCH</title>
        <meta name="description" content="Custom 3D printed earrings" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-gem mr-3"></i> Earrings
            </h1>
            <p className="text-lg text-gray-600">Custom 3D printed earrings</p>
          </div>
