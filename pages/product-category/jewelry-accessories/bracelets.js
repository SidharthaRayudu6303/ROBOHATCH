...
export default function Bracelets() {
  ...
  const products = [
    { id: 'bra1', name: 'Chain Bracelet', price: 549, icon: 'fa-link', description: 'Interlocking chain bracelet', image: '/products/bracelet-chain.jpg' },
    { id: 'bra2', name: 'Charm Bracelet', price: 599, icon: 'fa-star', description: 'Customizable charm bracelet', image: '/products/bracelet-charm.jpg' },
    { id: 'bra3', name: 'Bangle Bracelet', price: 499, icon: 'fa-ring', description: 'Solid bangle bracelet', image: '/products/bracelet-bangle.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Bracelets | ROBOHATCH</title>
        <meta name="description" content="Custom designed bracelets" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-link mr-3"></i> Bracelets
            </h1>
            <p className="text-lg text-gray-600">Custom designed bracelets</p>
          </div>
