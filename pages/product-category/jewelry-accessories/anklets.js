...
export default function Anklets() {
  ...
  const products = [
    { id: 'ank1', name: 'Chain Anklet', price: 449, icon: 'fa-link', description: 'Delicate chain anklet', image: '/products/anklet-chain.jpg' },
    { id: 'ank2', name: 'Charm Anklet', price: 499, icon: 'fa-heart', description: 'Anklet with charms', image: '/products/anklet-charm.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Anklets | ROBOHATCH</title>
        <meta name="description" content="Beautiful ankle jewelry" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-link mr-3"></i> Anklets
            </h1>
            <p className="text-lg text-gray-600">Beautiful ankle jewelry</p>
          </div>
