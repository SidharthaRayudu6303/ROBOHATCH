...
export default function SphereLamp() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'sphere1', name: 'Sphere Night Light', price: 599, icon: 'fa-circle', description: 'Glowing sphere lamp', image: '/products/lamp-sphere.jpg' },
    { id: 'sphere2', name: 'Levitating Sphere Lamp', price: 1549, icon: 'fa-globe', description: 'Magnetic levitation lamp', image: '/products/lamp-levitate.jpg' },
    { id: 'sphere3', name: 'Color Changing Sphere', price: 749, icon: 'fa-dot-circle', description: 'RGB sphere lamp', image: '/products/lamp-rgb.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Sphere Lamp | ROBOHATCH</title>
        <meta name="description" content="Spherical ambient lamps" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-circle mr-3"></i> Sphere Lamp
            </h1>
            <p className="text-lg text-gray-600">Spherical ambient lamps</p>
          </div>
