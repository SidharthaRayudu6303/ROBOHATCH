...
export default function StarLamp() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'star1', name: 'Star Night Light', price: 599, icon: 'fa-star', description: 'Star-shaped night light', image: '/products/lamp-star.jpg' },
    { id: 'star2', name: 'Galaxy Star Projector', price: 1199, icon: 'fa-star', description: 'Star projection lamp', image: '/products/lamp-galaxy.jpg' },
    { id: 'star3', name: 'LED Star Lamp', price: 749, icon: 'fa-star', description: 'Decorative star LED', image: '/products/lamp-star-led.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Star Lamp | ROBOHATCH</title>
        <meta name="description" content="Star-shaped decorative lamps" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-star mr-3"></i> Star Lamp
            </h1>
            <p className="text-lg text-gray-600">Star-shaped decorative lamps</p>
          </div>
