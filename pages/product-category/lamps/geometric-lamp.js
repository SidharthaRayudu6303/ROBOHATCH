...
export default function GeometricLamp() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'geo1', name: 'Hexagon Lamp', price: 799, icon: 'fa-shapes', description: 'Modern hexagonal lamp', image: '/products/lamp-hexagon.jpg' },
    { id: 'geo2', name: 'Triangle Lamp', price: 749, icon: 'fa-triangle', description: 'Geometric triangle design', image: '/products/lamp-triangle.jpg' },
    { id: 'geo3', name: 'Diamond Lamp', price: 899, icon: 'fa-gem', description: 'Diamond-shaped LED lamp', image: '/products/lamp-diamond.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Geometric Lamp | ROBOHATCH</title>
        <meta name="description" content="Modern geometric LED lamps" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-shapes mr-3"></i> Geometric Lamp
            </h1>
            <p className="text-lg text-gray-600">Modern geometric LED lamps</p>
          </div>
