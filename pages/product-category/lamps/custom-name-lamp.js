...
export default function CustomNameLamp() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'name1', name: 'Custom Name LED Lamp', price: 899, icon: 'fa-font', description: 'Personalized name lamp', image: '/products/lamp-name.jpg' },
    { id: 'name2', name: 'LED Name Sign', price: 1099, icon: 'fa-signature', description: 'Neon-style name sign', image: '/products/lamp-sign.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Custom Name Lamp | ROBOHATCH</title>
        <meta name="description" content="Personalized LED name lamps" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-font mr-3"></i> Custom Name Lamp
            </h1>
            <p className="text-lg text-gray-600">Personalized LED name lamps</p>
          </div>
