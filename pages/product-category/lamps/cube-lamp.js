...
export default function CubeLamp() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'cube1', name: 'LED Cube Lamp', price: 649, icon: 'fa-cube', description: 'Minimalist cube lamp', image: '/products/lamp-cube.jpg' },
    { id: 'cube2', name: 'Infinity Cube Lamp', price: 899, icon: 'fa-cubes', description: 'Infinity mirror cube', image: '/products/lamp-infinity.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Cube Lamp | ROBOHATCH</title>
        <meta name="description" content="Cube-shaped modern lamps" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-cube mr-3"></i> Cube Lamp
            </h1>
            <p className="text-lg text-gray-600">Cube-shaped modern lamps</p>
          </div>
