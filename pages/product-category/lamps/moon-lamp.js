...
export default function MoonLamp() {
  ...
  const products = [
    { id: 'moon1', name: '15cm Moon Lamp', price: 999, icon: 'fa-moon', description: '15cm 3D moon lamp', image: '/products/lamp-moon-15.jpg' },
    { id: 'moon2', name: '20cm Moon Lamp', price: 1299, icon: 'fa-moon', description: '20cm 3D moon lamp', image: '/products/lamp-moon-20.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Moon Lamp | ROBOHATCH</title>
        <meta name="description" content="3D printed moon lamps" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-moon mr-3"></i> Moon Lamp
            </h1>
            <p className="text-lg text-gray-600">3D printed moon lamps</p>
          </div>
