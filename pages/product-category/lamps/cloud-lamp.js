...
export default function CloudLamp() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'cloud1', name: 'Cloud Night Light', price: 799, icon: 'fa-cloud', description: 'Fluffy cloud lamp', image: '/products/lamp-cloud.jpg' },
    { id: 'cloud2', name: 'Thunder Cloud Lamp', price: 999, icon: 'fa-cloud-bolt', description: 'Cloud with thunder effect', image: '/products/lamp-thunder.jpg' },
    { id: 'cloud3', name: 'Rainbow Cloud Lamp', price: 899, icon: 'fa-cloud-sun', description: 'Cloud with rainbow', image: '/products/lamp-rainbow.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Cloud Lamp | ROBOHATCH</title>
        <meta name="description" content="Cloud-shaped ambient lamps" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-cloud mr-3"></i> Cloud Lamp
            </h1>
            <p className="text-lg text-gray-600">Cloud-shaped ambient lamps</p>
          </div>
