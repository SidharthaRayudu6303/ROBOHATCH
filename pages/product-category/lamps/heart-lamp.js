...
export default function HeartLamp() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'heart1', name: 'Heart Night Light', price: 699, icon: 'fa-heart', description: 'Romantic heart lamp', image: '/products/lamp-heart.jpg' },
    { id: 'heart2', name: 'Double Heart Lamp', price: 849, icon: 'fa-heart', description: 'Interlocked hearts lamp', image: '/products/lamp-double-heart.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Heart Lamp | ROBOHATCH</title>
        <meta name="description" content="Heart-shaped romantic lamps" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-heart mr-3"></i> Heart Lamp
            </h1>
            <p className="text-lg text-gray-600">Heart-shaped romantic lamps</p>
          </div>
