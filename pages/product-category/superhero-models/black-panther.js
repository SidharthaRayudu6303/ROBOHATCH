...
export default function BlackPanther() {
  ...
  const products = [
    { id: 'bp1', name: 'Black Panther Classic', price: 1399, icon: 'fa-cat', description: 'Wakanda Forever king figure', image: '/products/black-panther.jpg' },
    { id: 'bp2', name: 'Black Panther Vibranium', price: 1499, icon: 'fa-shield-alt', description: 'With vibranium effects', image: '/products/bp-vibranium.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Black Panther Figures | ROBOHATCH</title>
        <meta name="description" content="Wakanda Forever king figures" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-cat mr-3"></i> Black Panther
            </h1>
            <p className="text-lg text-gray-600">Wakanda Forever king figures</p>
          </div>
