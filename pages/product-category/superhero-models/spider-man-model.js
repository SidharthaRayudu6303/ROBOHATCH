...
export default function SpiderManModel() {
  ...
  const products = [
    { id: 'sm1', name: 'Spider-Man Homecoming', price: 1199, icon: 'fa-spider', description: 'Tom Holland Spider-Man model', image: '/products/spiderman-homecoming.jpg' },
    { id: 'sm2', name: 'Spider-Man Miles Morales', price: 1249, icon: 'fa-mask', description: 'Into the Spider-Verse figure', image: '/products/spiderman-miles.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Spider-Man Models | ROBOHATCH</title>
        <meta name="description" content="Amazing Spider-Man collectibles" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-spider mr-3"></i> Spider-Man Models
            </h1>
            <p className="text-lg text-gray-600">Amazing Spider-Man collectibles</p>
          </div>
