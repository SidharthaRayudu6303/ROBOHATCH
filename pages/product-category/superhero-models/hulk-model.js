...
export default function HulkModel() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'hulk1', name: 'Hulk Smash', price: 1449, icon: 'fa-fist-raised', description: 'Incredible Hulk in action pose', image: '/products/hulk-smash.jpg' },
    { id: 'hulk2', name: 'Professor Hulk', price: 1499, icon: 'fa-user-graduate', description: 'Smart Hulk from Endgame', image: '/products/hulk-professor.jpg' },
    { id: 'hulk3', name: 'Gladiator Hulk', price: 1549, icon: 'fa-shield', description: 'Ragnarok arena champion', image: '/products/hulk-gladiator.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Hulk Models | ROBOHATCH</title>
        <meta name="description" content="The Incredible Hulk figures" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-fist-raised mr-3"></i> Hulk Models
            </h1>
            <p className="text-lg text-gray-600">The Incredible Hulk figures</p>
          </div>
