...
export default function ThorFigure() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'thor1', name: 'Thor Ragnarok', price: 1349, icon: 'fa-bolt', description: 'Short hair Thor with lightning', image: '/products/thor-ragnarok.jpg' },
    { id: 'thor2', name: 'Thor Endgame', price: 1399, icon: 'fa-hammer', description: 'Stormbreaker and Mjolnir Thor', image: '/products/thor-endgame.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Thor Figures | ROBOHATCH</title>
        <meta name="description" content="God of Thunder with hammer" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-bolt mr-3"></i> Thor Figures
            </h1>
            <p className="text-lg text-gray-600">God of Thunder with hammer</p>
          </div>
