...
export default function BatmanStatue() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'bat1', name: 'Batman Dark Knight', price: 1399, icon: 'fa-bat', description: 'Tactical Dark Knight Batman statue', image: '/products/batman-dk.jpg' },
    { id: 'bat2', name: 'Batman Classic', price: 1349, icon: 'fa-mask', description: 'Classic blue and gray Batman', image: '/products/batman-classic.jpg' },
    { id: 'bat3', name: 'Batman Arkham', price: 1399, icon: 'fa-bat', description: 'Arkham Knight Batman figure', image: '/products/batman-arkham.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Batman Statues | ROBOHATCH</title>
        <meta name="description" content="Dark Knight premium statues" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-bat mr-3"></i> Batman Statues
            </h1>
            <p className="text-lg text-gray-600">Dark Knight premium statues</p>
          </div>
