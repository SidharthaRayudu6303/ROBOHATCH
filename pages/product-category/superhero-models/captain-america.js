...
export default function CaptainAmerica() {
  ...
  const products = [
    { id: 'cap1', name: 'Captain America Endgame', price: 1499, icon: 'fa-shield-alt', description: 'Worthy Cap with Mjolnir', image: '/products/cap-endgame.jpg' },
    { id: 'cap2', name: 'Captain America Classic', price: 1399, icon: 'fa-star', description: 'First Avenger classic look', image: '/products/cap-classic.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Captain America Figures | ROBOHATCH</title>
        <meta name="description" content="First Avenger shield included" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-shield-alt mr-3"></i> Captain America
            </h1>
            <p className="text-lg text-gray-600">First Avenger shield included</p>
          </div>
