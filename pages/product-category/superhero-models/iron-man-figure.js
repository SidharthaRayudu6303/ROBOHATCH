...
export default function IronManFigure() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'im1', name: 'Iron Man Mark 50', price: 1299, icon: 'fa-robot', description: 'Detailed Infinity War Iron Man figure', image: '/products/ironman-mk50.jpg' },
    { id: 'im2', name: 'Iron Man Classic', price: 1199, icon: 'fa-user-astronaut', description: 'Original red and gold armor', image: '/products/ironman-classic.jpg' },
    { id: 'im3', name: 'Iron Man Mark 85', price: 1399, icon: 'fa-robot', description: 'Endgame final armor', image: '/products/ironman-mk85.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Iron Man Figures | ROBOHATCH</title>
        <meta name="description" content="Detailed Iron Man action figures" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-robot mr-3"></i> Iron Man Figures
            </h1>
            <p className="text-lg text-gray-600">Detailed Iron Man action figures</p>
          </div>
