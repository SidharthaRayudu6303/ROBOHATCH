...
export default function BuildingBlocks() {
  ...
  const products = [
    { id: 'bb1', name: 'Basic Block Set', price: 549, icon: 'fa-cubes', description: '50 piece building blocks', image: '/products/blocks-basic.jpg' },
    { id: 'bb2', name: 'Architect Block Set', price: 749, icon: 'fa-building', description: 'Advanced construction set', image: '/products/blocks-architect.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Building Blocks | ROBOHATCH</title>
        <meta name="description" content="Construction building blocks" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-cubes mr-3"></i> Building Blocks
            </h1>
            <p className="text-lg text-gray-600">Construction building blocks</p>
          </div>
