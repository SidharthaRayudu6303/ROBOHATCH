...
export default function MiniCars() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'mc1', name: 'Racing Car Model', price: 299, icon: 'fa-car', description: 'Mini racing car', image: '/products/car-racing.jpg' },
    { id: 'mc2', name: 'Vintage Car Model', price: 349, icon: 'fa-car-side', description: 'Classic vintage car', image: '/products/car-vintage.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Mini Cars | ROBOHATCH</title>
        <meta name="description" content="Miniature car models" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-car mr-3"></i> Mini Cars
            </h1>
            <p className="text-lg text-gray-600">Miniature car models</p>
          </div>
