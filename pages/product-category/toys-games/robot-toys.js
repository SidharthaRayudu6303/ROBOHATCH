...
export default function RobotToys() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'rt1', name: 'Humanoid Robot', price: 799, icon: 'fa-robot', description: 'Articulated humanoid robot', image: '/products/robot-humanoid.jpg' },
    { id: 'rt2', name: 'Mech Robot', price: 849, icon: 'fa-cog', description: 'Mechanical warfare robot', image: '/products/robot-mech.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Robot Toys | ROBOHATCH</title>
        <meta name="description" content="Futuristic robot toys" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-robot mr-3"></i> Robot Toys
            </h1>
            <p className="text-lg text-gray-600">Futuristic robot toys</p>
          </div>
