...
export default function EducationalToy() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'et1', name: 'Alphabet Learning Set', price: 449, icon: 'fa-graduation-cap', description: 'Educational alphabet pieces', image: '/products/edu-alphabet.jpg' },
    { id: 'et2', name: 'Number Puzzle', price: 399, icon: 'fa-calculator', description: 'Math learning puzzle', image: '/products/edu-numbers.jpg' },
    { id: 'et3', name: 'Shape Sorter', price: 349, icon: 'fa-shapes', description: 'Geometric shape learning', image: '/products/edu-shapes.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Educational Toys | ROBOHATCH</title>
        <meta name="description" content="Learning toys for kids" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-graduation-cap mr-3"></i> Educational Toys
            </h1>
            <p className="text-lg text-gray-600">Learning toys for kids</p>
          </div>
