...
export default function DinosaurModels() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'dm1', name: 'T-Rex Model', price: 599, icon: 'fa-dragon', description: 'Tyrannosaurus Rex figure', image: '/products/dino-trex.jpg' },
    { id: 'dm2', name: 'Triceratops Model', price: 549, icon: 'fa-hippo', description: 'Triceratops dinosaur', image: '/products/dino-tri.jpg' },
    { id: 'dm3', name: 'Brachiosaurus Model', price: 649, icon: 'fa-horse', description: 'Long neck dinosaur', image: '/products/dino-brach.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Dinosaur Models | ROBOHATCH</title>
        <meta name="description" content="3D printed dinosaur figures" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-dragon mr-3"></i> Dinosaur Models
            </h1>
            <p className="text-lg text-gray-600">3D printed dinosaur figures</p>
          </div>
