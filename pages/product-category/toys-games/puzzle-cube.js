...
export default function PuzzleCube() {
  ...
  const products = [
    { id: 'pc1', name: '3x3 Speed Cube', price: 349, icon: 'fa-cube', description: 'Classic 3x3 Rubiks cube', image: '/products/cube-3x3.jpg' },
    { id: 'pc2', name: '4x4 Master Cube', price: 449, icon: 'fa-cubes', description: 'Advanced 4x4 puzzle cube', image: '/products/cube-4x4.jpg' },
    { id: 'pc3', name: 'Pyramid Puzzle', price: 399, icon: 'fa-shapes', description: 'Triangular pyramid puzzle', image: '/products/cube-pyramid.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Puzzle Cubes | ROBOHATCH</title>
        <meta name="description" content="3D printed puzzle cubes" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-cube mr-3"></i> Puzzle Cubes
            </h1>
            <p className="text-lg text-gray-600">3D printed puzzle cubes</p>
          </div>
