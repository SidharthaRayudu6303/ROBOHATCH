...
export default function BoardGamePieces() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'bg1', name: 'Chess Pieces Set', price: 699, icon: 'fa-chess', description: 'Complete chess pieces', image: '/products/game-chess.jpg' },
    { id: 'bg2', name: 'Custom Game Tokens', price: 399, icon: 'fa-dice', description: 'Custom board game tokens', image: '/products/game-tokens.jpg' },
    { id: 'bg3', name: 'Miniature Figures', price: 549, icon: 'fa-users', description: 'Game miniature figures', image: '/products/game-mini.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Board Game Pieces | ROBOHATCH</title>
        <meta name="description" content="Custom board game pieces" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-chess mr-3"></i> Board Game Pieces
            </h1>
            <p className="text-lg text-gray-600">Custom board game pieces</p>
          </div>
