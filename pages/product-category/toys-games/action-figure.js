...
export default function ActionFigure() {
  ...
  const products = [
    { id: 'af1', name: 'Soldier Action Figure', price: 599, icon: 'fa-user-ninja', description: 'Poseable military figure', image: '/products/action-soldier.jpg' },
    { id: 'af2', name: 'Robot Action Figure', price: 649, icon: 'fa-robot', description: 'Articulated robot toy', image: '/products/action-robot.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Action Figures | ROBOHATCH</title>
        <meta name="description" content="Articulated action figures" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-user-ninja mr-3"></i> Action Figures
            </h1>
            <p className="text-lg text-gray-600">Articulated action figures</p>
          </div>
