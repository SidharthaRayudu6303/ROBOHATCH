...
export default function CandleHolders() {
  ...
  const products = [
    { id: 'ch1', name: 'Geometric Candle Holder', price: 399, icon: 'fa-fire', description: 'Modern geometric design', image: '/products/candle-geometric.jpg' },
    { id: 'ch2', name: 'Spiral Candle Holder', price: 449, icon: 'fa-burn', description: 'Spiral pattern holder', image: '/products/candle-spiral.jpg' },
    { id: 'ch3', name: 'Set of 3 Holders', price: 749, icon: 'fa-fire-alt', description: 'Matching set of 3', image: '/products/candle-set.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Candle Holders | ROBOHATCH</title>
        <meta name="description" content="Decorative candle holders" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-fire mr-3"></i> Candle Holders
            </h1>
            <p className="text-lg text-gray-600">Decorative candle holders</p>
          </div>
