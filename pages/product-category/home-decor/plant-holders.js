...
export default function PlantHolders() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'ph1', name: 'Hanging Plant Holder', price: 449, icon: 'fa-seedling', description: 'Suspended plant holder', image: '/products/holder-hanging.jpg' },
    { id: 'ph2', name: 'Wall Mount Holder', price: 399, icon: 'fa-leaf', description: 'Wall-mounted plant holder', image: '/products/holder-wall.jpg' },
    { id: 'ph3', name: 'Desktop Plant Holder', price: 349, icon: 'fa-spa', description: 'Small desktop planter', image: '/products/holder-desk.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Plant Holders | ROBOHATCH</title>
        <meta name="description" content="Creative plant holders" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-seedling mr-3"></i> Plant Holders
            </h1>
            <p className="text-lg text-gray-600">Creative plant holders</p>
          </div>
