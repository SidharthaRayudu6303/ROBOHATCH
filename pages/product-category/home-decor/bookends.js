...
export default function Bookends() {
  ...
  const products = [
    { id: 'be1', name: 'Modern Bookends', price: 549, icon: 'fa-book', description: 'Minimalist bookend pair', image: '/products/bookend-modern.jpg' },
    { id: 'be2', name: 'Animal Bookends', price: 599, icon: 'fa-cat', description: 'Animal-shaped bookends', image: '/products/bookend-animal.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Bookends | ROBOHATCH</title>
        <meta name="description" content="Stylish bookend designs" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-book mr-3"></i> Bookends
            </h1>
            <p className="text-lg text-gray-600">Stylish bookend designs</p>
          </div>
