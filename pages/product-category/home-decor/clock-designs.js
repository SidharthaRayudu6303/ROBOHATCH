...
export default function ClockDesigns() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'cd1', name: 'Modern Wall Clock', price: 799, icon: 'fa-clock', description: 'Minimalist modern clock', image: '/products/clock-modern.jpg' },
    { id: 'cd2', name: 'Geometric Clock', price: 849, icon: 'fa-shapes', description: 'Geometric pattern clock', image: '/products/clock-geometric.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Clock Designs | ROBOHATCH</title>
        <meta name="description" content="Unique wall clock designs" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-clock mr-3"></i> Clock Designs
            </h1>
            <p className="text-lg text-gray-600">Unique wall clock designs</p>
          </div>
