...
export default function WallArt() {
  ...
  const products = [
    { id: 'wa1', name: 'Geometric Wall Art', price: 799, icon: 'fa-shapes', description: 'Modern geometric design', image: '/products/wall-geometric.jpg' },
    { id: 'wa2', name: 'Nature Wall Art', price: 849, icon: 'fa-leaf', description: 'Nature inspired wall decor', image: '/products/wall-nature.jpg' },
    { id: 'wa3', name: 'Abstract Wall Art', price: 899, icon: 'fa-palette', description: 'Abstract artistic wall piece', image: '/products/wall-abstract.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Wall Art | ROBOHATCH</title>
        <meta name="description" content="Decorative wall art pieces" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-shapes mr-3"></i> Wall Art
            </h1>
            <p className="text-lg text-gray-600">Decorative wall art pieces</p>
          </div>
