...
export default function LampShades() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'ls1', name: 'Geometric Lamp Shade', price: 599, icon: 'fa-lightbulb', description: 'Modern geometric design', image: '/products/shade-geometric.jpg' },
    { id: 'ls2', name: 'Floral Lamp Shade', price: 649, icon: 'fa-spa', description: 'Floral pattern shade', image: '/products/shade-floral.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Lamp Shades | ROBOHATCH</title>
        <meta name="description" content="Decorative lamp shade designs" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-lightbulb mr-3"></i> Lamp Shades
            </h1>
            <p className="text-lg text-gray-600">Decorative lamp shade designs</p>
          </div>
