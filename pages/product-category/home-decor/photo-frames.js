...
export default function PhotoFrames() {
  ...
  const products = [
    { id: 'pf1', name: 'Modern Photo Frame', price: 349, icon: 'fa-image', description: 'Minimalist modern frame', image: '/products/frame-modern.jpg' },
    { id: 'pf2', name: 'Collage Frame', price: 549, icon: 'fa-images', description: 'Multi-photo collage frame', image: '/products/frame-collage.jpg' },
    { id: 'pf3', name: 'Decorative Frame', price: 449, icon: 'fa-border-style', description: 'Ornate decorative frame', image: '/products/frame-decorative.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Photo Frames | ROBOHATCH</title>
        <meta name="description" content="Custom 3D printed frames" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-image mr-3"></i> Photo Frames
            </h1>
            <p className="text-lg text-gray-600">Custom 3D printed frames</p>
          </div>
