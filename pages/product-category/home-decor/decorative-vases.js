...
export default function DecorativeVases() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'dv1', name: 'Modern Vase', price: 649, icon: 'fa-wine-bottle', description: 'Sleek modern design vase', image: '/products/vase-modern.jpg' },
    { id: 'dv2', name: 'Textured Vase', price: 699, icon: 'fa-vial', description: 'Textured pattern vase', image: '/products/vase-textured.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Decorative Vases | ROBOHATCH</title>
        <meta name="description" content="Modern decorative vases" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-wine-bottle mr-3"></i> Decorative Vases
            </h1>
            <p className="text-lg text-gray-600">Modern decorative vases</p>
          </div>
