...
export default function ChargingDocks() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'dock1', name: 'Single Phone Dock', price: 449, icon: 'fa-plug', description: 'Desktop charging dock', image: '/products/dock-single.jpg' },
    { id: 'dock2', name: 'Multi-Device Dock', price: 799, icon: 'fa-charging-station', description: '3-in-1 charging dock', image: '/products/dock-multi.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Charging Docks | ROBOHATCH</title>
        <meta name="description" content="Phone charging dock stations" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-plug mr-3"></i> Charging Docks
            </h1>
            <p className="text-lg text-gray-600">Phone charging dock stations</p>
          </div>
