...
export default function CustomCases() {
  ...
  const products = [
    { id: 'cc1', name: 'Armor Case', price: 599, icon: 'fa-shield-alt', description: 'Heavy duty protection', image: '/products/case-armor.jpg' },
    { id: 'cc2', name: 'Slim Case', price: 449, icon: 'fa-mobile-alt', description: 'Minimalist design', image: '/products/case-slim.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Custom Cases | ROBOHATCH</title>
        <meta name="description" content="Custom 3D printed phone cases" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-mobile-alt mr-3"></i> Custom Cases
            </h1>
            <p className="text-lg text-gray-600">Custom 3D printed phone cases</p>
          </div>
