...
export default function ScreenProtectors() {
  ...
  const products = [
    { id: 'sp1', name: 'Privacy Screen Protector', price: 399, icon: 'fa-eye-slash', description: 'Anti-spy screen guard', image: '/products/screen-privacy.jpg' },
    { id: 'sp2', name: 'Matte Screen Protector', price: 299, icon: 'fa-mobile', description: 'Anti-glare matte finish', image: '/products/screen-matte.jpg' },
    { id: 'sp3', name: 'Clear Screen Protector', price: 249, icon: 'fa-mobile-alt', description: 'Crystal clear protection', image: '/products/screen-clear.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Screen Protectors | ROBOHATCH</title>
        <meta name="description" content="Phone screen protection" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-mobile mr-3"></i> Screen Protectors
            </h1>
            <p className="text-lg text-gray-600">Phone screen protection</p>
          </div>
