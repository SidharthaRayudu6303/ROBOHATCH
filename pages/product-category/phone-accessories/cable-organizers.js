...
export default function CableOrganizers() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'co1', name: 'Cable Clips', price: 149, icon: 'fa-paperclip', description: 'Adhesive cable clips', image: '/products/organizer-clip.jpg' },
    { id: 'co2', name: 'Cable Holder', price: 199, icon: 'fa-grip-lines', description: 'Multi-cable holder', image: '/products/organizer-holder.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Cable Organizers | ROBOHATCH</title>
        <meta name="description" content="Cable management solutions" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-paperclip mr-3"></i> Cable Organizers
            </h1>
            <p className="text-lg text-gray-600">Cable management solutions</p>
          </div>
