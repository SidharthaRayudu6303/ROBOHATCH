...
export default function PopSockets() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'pop1', name: 'Custom Design Pop Socket', price: 199, icon: 'fa-circle', description: 'Personalized pop socket', image: '/products/pop-custom.jpg' },
    { id: 'pop2', name: 'Geometric Pop Socket', price: 179, icon: 'fa-shapes', description: 'Modern geometric design', image: '/products/pop-geometric.jpg' },
    { id: 'pop3', name: 'Logo Pop Socket', price: 219, icon: 'fa-stamp', description: 'Custom logo pop socket', image: '/products/pop-logo.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Pop Sockets | ROBOHATCH</title>
        <meta name="description" content="Custom pop socket grips" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-circle mr-3"></i> Pop Sockets
            </h1>
            <p className="text-lg text-gray-600">Custom pop socket grips</p>
          </div>
