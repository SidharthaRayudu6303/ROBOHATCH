...
export default function PhoneGrips() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'pg1', name: 'Ring Grip', price: 249, icon: 'fa-ring', description: 'Rotating ring grip', image: '/products/grip-ring.jpg' },
    { id: 'pg2', name: 'Loop Grip', price: 199, icon: 'fa-hand-paper', description: 'Elastic loop grip', image: '/products/grip-loop.jpg' },
    { id: 'pg3', name: 'Card Holder Grip', price: 299, icon: 'fa-id-card', description: 'Grip with card holder', image: '/products/grip-card.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Phone Grips | ROBOHATCH</title>
        <meta name="description" content="Secure phone grip accessories" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-hand-paper mr-3"></i> Phone Grips
            </h1>
            <p className="text-lg text-gray-600">Secure phone grip accessories</p>
          </div>
