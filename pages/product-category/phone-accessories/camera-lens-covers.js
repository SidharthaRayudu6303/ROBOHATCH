...
export default function CameraLensCovers() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'lens1', name: 'Metal Lens Protector', price: 349, icon: 'fa-camera', description: 'Metal camera lens guard', image: '/products/lens-metal.jpg' },
    { id: 'lens2', name: 'Glass Lens Cover', price: 299, icon: 'fa-video', description: 'Tempered glass lens cover', image: '/products/lens-glass.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Camera Lens Covers | ROBOHATCH</title>
        <meta name="description" content="Phone camera lens protection" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-camera mr-3"></i> Camera Lens Covers
            </h1>
            <p className="text-lg text-gray-600">Phone camera lens protection</p>
          </div>
