...
export default function PhoneStands() {
  const [notification, setNotification] = useState('')
  
  const products = [
    { id: 'ps1', name: 'Adjustable Phone Stand', price: 349, icon: 'fa-mobile-alt', description: 'Multi-angle adjustable stand', image: '/products/stand-adjustable.jpg' },
    { id: 'ps2', name: 'Desk Phone Stand', price: 299, icon: 'fa-mobile', description: 'Compact desk stand', image: '/products/stand-desk.jpg' },
    { id: 'ps3', name: 'Foldable Stand', price: 399, icon: 'fa-expand', description: 'Portable foldable stand', image: '/products/stand-fold.jpg' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Phone Stands | ROBOHATCH</title>
        <meta name="description" content="Adjustable phone stands" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-dark-brown mb-4">
              <i className="fas fa-mobile-alt mr-3"></i> Phone Stands
            </h1>
            <p className="text-lg text-gray-600">Adjustable phone stands</p>
          </div>
