/**
 * Central API Client
 * Handles all API requests with cookie-based authentication
 */
...
export async function getProduct(productId) {
  try {
    return await apiGet(`/api/v1/products/${productId}`);
  } catch (error) {
...
export async function getCart() {
  try {
    return await apiGet('/api/v1/cart');
  } catch (error) {
...
export async function addToCart(item) {
  try {
    return await apiPost('/api/v1/cart/items', item);
  } catch (error) {
...
export async function updateCartItem(itemId, updates) {
  try {
    return await apiPut(`/api/v1/cart/items/${itemId}`, updates);
  } catch (error) {
...
export async function removeFromCart(itemId) {
  try {
    return await apiDelete(`/api/v1/cart/items/${itemId}`);
  } catch (error) {
...
export async function getOrder(orderId) {
  try {
    return await apiGet(`/api/v1/orders/${orderId}`);
  } catch (error) {
...
export async function getOrders() {
  try {
    return await apiGet('/api/v1/orders');
  } catch (error) {
...
export async function getPaymentStatus(orderId) {
  try {
    return await apiGet(`/api/v1/payments/${orderId}`);
  } catch (error) {
